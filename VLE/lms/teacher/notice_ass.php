					...
					<form action="#" method="post" enctype="multipart/form-data">
						...
						<div class="row">
							...
							<div class="input-field col s12">
								...
								<input id="from" type="number" name="from_age" required min="5">
							</div>

							<div class="input-field col s12">
								<label for="to">TO AGE</label><br>
								<input id="to" type="number" name="to_age" required min="5">
							</div>
							<div class="input-field col s12">
								<label for="class">Grade</label><br>
								<input id="clsdd" type="number" name="class" required>
							</div>
