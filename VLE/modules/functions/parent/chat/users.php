...
<div id="content">
  ...
  <div class="container-fluid">
    <!-- Feeds Heading -->
    <div style="background-color: green; color:white;" class="card d-sm-flex align-items-center justify-content-between mb-4 py-2 h5">
      <h5 class="h5 mb-0 text-info " style="color:white !important;">Parent Teacher Interaction </h5>
    </div>
