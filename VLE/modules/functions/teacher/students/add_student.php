                        ...
                        <table class="table" id="" width="100%" cellspacing="9">
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    ...
                                    <input id="f" type="radio" name="gender" value="Female" onclick="this.value"> <label for="f">Female</label>
                                </td>
                            </tr>
                            <tr>
                                <td>Student DOB:</td>
...
if (isset($_POST['create_student'])) {
    ...
    //** 1 create user
    mysqli_query($db, "INSERT INTO users (`userid`, `name`, `username`, `password`, `user_role`, `phone`, `email`, `address` ) 
            VALUES('$user_id', '$stuName','$username', '$stuPassword','student','$stuPhone', '$stuEmail', '$stuAddress' )") or die('Could not enter data 1: ' . mysqli_error($db));

    $id = mysqli_insert_id($db); // user ID
    //** 2 create student */
    $sql = "INSERT INTO students (`user_id`,`name`, `username`, `phone`, `email`, `sex`, `dob`, `addmissiondate`, `address`, `parentid`, `class_id`, `img`, `created_by` )
             VALUES('$id', '$stuName','$username','$stuPhone','$stuEmail','$stugender','$stuDOB','$stuAddmissionDate','$stuAddress','$stuParentId','$class_id', '$img', '$user_id' )";

    $success = mysqli_query($db, $sql) or die('Could not enter data 2: ' . mysqli_error($db));
