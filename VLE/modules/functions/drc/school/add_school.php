                ...
                <div class="card-body" style=" border-color: black ">
                    <form action="#" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select id="zones" name="zone" class="form-control" required>
                                <option value="">Select Zone</option>
                                <?php
                                $query = mysqli_query($db, "SELECT * FROM zones WHERE district_id = $district_id_zone");
                                if ($query) {
                                    while ($row = mysqli_fetch_assoc($query)) {
                                        echo "<option value='{$row['zone_id']}'>{$row['zone']}</option>";
                                    }
                                }
                                ?>
                            </select>
