        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                            ...
                            <div class="card">
                                <div class="card-body bg-primary">
                                    <div class="card-body text-white">
                                        ...
                                        <h4><b>
                                            <?php echo $db->query("SELECT * FROM users")->num_rows; ?>
                                        </b></h4>
                                        <p><b>Users</b></p>
                                    </div>
                                </div>
                            ...
                            <div class="card">
                                <div class="card-body bg-info">
                                    <div class="card-body text-white">
                                        ...
                                        <h4><b>
                                            <?php echo $db->query("SELECT * FROM topics")->num_rows; ?>
                                        </b></h4>
                            ...
                            <div class="card">
                                <div class="card-body bg-warning">
                                    <div class="card-body text-white">
                                        ...
                                        <h4><b>
                                            <?php echo $db->query("SELECT * FROM categories")->num_rows; ?>
                                        </b></h4>
                                        <p><b>Tags</b></p>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                    <?php
                     $tags = $db->query("SELECT * FROM categories order by name asc");
