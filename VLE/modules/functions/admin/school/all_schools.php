    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="4">
                ...
                <tbody>
                    <?php
                    $sql = "SELECT s.*, z.zone, d.district_name, p.province_name, s.province FROM schools s
                                LEFT JOIN zones z ON z.zone_id = s.zone
                                LEFT JOIN districts d ON s.district = d.district_id
                                LEFT JOIN provinces p ON p.province_id = s.province";
